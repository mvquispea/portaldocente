...
<ul>
    @foreach($docentes as $docente)
        <li>
            ...
            <strong>Fecha de Nacimiento:</strong> {{ $docente->fechanacimiento }} <br>
            <!-- Continuar con otras columnas según sea necesario -->
        </li>
    @endforeach
</ul>
									...
									<div class="card card-flush">
										...
										<div class="card-header align-items-center py-5 gap-2 gap-md-5">
											...
											<div class="card-toolbar flex-row-fluid justify-content-end gap-5">
												...
												<!--begin::Add product-->
												<a href="../../demo1/dist/apps/ecommerce/catalog/add-product.html" class="btn btn-primary">Agregar docente</a>
												<!--end::Add product-->
											</div>
											<!--end::Card toolbar-->
										</div>
											...
											<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_products_table">
												...
												<thead>
													...
													<tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
														...
														<th class="min-w-200px">Docentes</th>
														<th class="text-end min-w-100px">DNI</th>
													...
													<tr>
														...
														<td>
															<div class="d-flex align-items-center">
																<div class="ms-5">
																	<span class="text-gray-800 text-hover-primary fs-5 fw-bold">{{ $docente->nombres }} {{ $docente->apellidos }}</span>
																</div>
															</div>
														</td>
														<!-- DNI -->
														<td class="text-end pe-0">
															<span class="fw-bold">{{ $docente->numero }}</span>
														</td>
														<!-- Estado -->
														<td class="text-end pe-0" data-order="Published">
															<div class="badge badge-light-success">{{ $docente->estado }}</div>
														</td>
														<!-- Acciones -->
														<td class="text-end">

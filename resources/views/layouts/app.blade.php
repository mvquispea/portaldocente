							...
							<div class="app-navbar flex-shrink-0">
								...
								<div class="app-navbar-item ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
									...
									<div class="cursor-pointer symbol symbol-35px symbol-md-40px" data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
										<img src="{{ $docente->foto ?? asset('assets/media/avatars/blank.png') }}" alt="user">
									</div>
									...
									<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px" data-kt-menu="true">
										...
										<div class="menu-item px-5">
											...
											<a href="{{ route('registro') }}" class="menu-link px-5">Gestionar Perfil</a>
											@endif
										</div>
										<!--end::Menu item-->
										<!--begin::Menu item-->
								...
								<div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false">
									...
									<div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
										...
										<span class="menu-link">
											...
											<span class="menu-title">Datos del docente</span>
										...
										<div class="menu-sub menu-sub-accordion">
											...
											<div class="menu-item">
												<!--begin:Menu link-->
												@if(auth()->user()->role === 'admin')
												<a class="menu-link" href="{{ route('listar') }}">
													<span class="menu-bullet">
														<span class="bullet bullet-dot"></span>
													</span>
													<span class="menu-title">Listas Docente</span>
												</a>
												@endif
												<!--end:Menu link-->
												<!--begin:Menu link-->
												@if(auth()->user()->role === 'editor')
												<a class="menu-link" href="{{ route('registro') }}">
													<span class="menu-bullet">
														<span class="bullet bullet-dot"></span>
													</span>
													<span class="menu-title">Registro perfil</span>
												</a>
												@endif
												<!--end:Menu link-->
								...
								<div data-kt-stepper-element="content">
									...
									<div class="w-100">
										...
										<div class="pb-8 pb-lg-10">
											...
											<a href="../../demo1/dist/authentication/sign-in/basic.html" class="link-primary fw-bold">Sign In</a>.</div>
											<!--end::Notice-->
										</div>
										<!--end::Heading-->
										<!--begin::Body-->
